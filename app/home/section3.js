          ...
          <div className="p-4">
            <div className="flex items-center justify-center">
              <div>
                ...
                >
                  Lengkapi website undangan digitalmu dengan beragam fitur yang
                  dapat disesuaikan dengan seleramu.
                </p>
                ...
                {list.map((item, index) => (
                  <div>
                    <h5 className="xl:mt-4 lg:mt-2 ml-1 xl:ml-3 lg:ml-3 flex items-center">
                      <span
                        className={`${styles.iconColor} xl:text-2xl lg:text-lg`}
                      >
                        <FaCircleCheck />
                      </span>
                      <span className={`ml-5 text-[1.3rem] font-medium`}>
                        {item.title}
                      </span>{" "}
                    </h5>
                    <p
                      className={`${styles.description} xl:mt-3 lg:mt-1 ml-14 xl:leading-[1.6rem] lg:leading-[1.3rem] text-base`}
                    >
                      {item.description}
                    </p>
                  </div>
