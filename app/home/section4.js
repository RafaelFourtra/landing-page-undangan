      ...
      <div className="grid xl:grid-cols-2 lg:grid-cols-2 grid-cols-1">
        ...
        <div className="xl:p-10 lg:p-10 p-7 px-1 flex items-center">
          <div>
            ...
            <h3 className="text-[#221C35] text-base">
              Kami selalu memberikan pelayanan & harga terbaik dalam pasar dan
              menyediakan transaksi 24 jam.
            </h3>
            <Button
              className={`${styles.buttonstyles} my-3`}
              radius="full"
              size="md"
            >
