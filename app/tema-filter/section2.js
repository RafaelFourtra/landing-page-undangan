            ...
            <div>
              ...
              <div className="p-3 px-5 bg-[#E7F0FF] rounded-b-lg">
                ...
                <div className="grid xl:grid-cols-2 lg:grid-cols-1 gap-2">
                  ...
                  <div>
                    <Button className="w-full bg-transparent text-[#035B7D] xl:mt-5 lg:mt-[-9px] border-2 border-[#035B7D] text-center" radius="xl:sm lg:full" size="xl:md lg:sm" onPress={onOpen}>Gunakan <MdOutlineShoppingCartCheckout /></Button>
                  </div>
                </div>
              </div>
            </div>
